                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <table class="js-table-checkable table table-hover table-vcenter">
                                        <tbody>
                                        @inject('indonesian_date', 'App\Http\Controllers\InboxController')
                                        @foreach($inboxs as $inbox)
                                            <tr>
                                                ...
                                                <td>
                                                    <!-- <a class="font-w600" data-toggle="modal" data-target="#modal-message" href="#">{{str_slug($inbox->TextDecoded, $limit=100, $end='...')}}</a> -->
                                                    <div class="text-muted mt-5">{{str_limit($inbox->TextDecoded, 50)}}</div>
                                                </td>
                                                <td class="d-none d-xl-table-cell font-w600 font-size-sm text-muted" style="width: 250px;">{{$indonesian_date->indonesian_date($inbox->ReceivingDateTime)}}</td>
                                            </tr>            
                                        @endforeach    
                                        </tbody>
                                    </table>
