                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    ...
                                    <table class="js-table-checkable table table-hover table-vcenter">
                                        <tbody>
                                        @inject('indonesian_date', 'App\Http\Controllers\OutboxController')
                                        @foreach($outboxs as $outbox)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="text-muted mt-5">{{str_limit($outbox->TextDecoded, 50)}}</div>
                                                </td>
                                                <td class="d-none d-xl-table-cell font-w600 font-size-sm text-muted" style="width: 250px;">{{$indonesian_date->indonesian_date()}}</td>
                                            </tr>
